...
from density2potential.core.linear_response import exact_susceptibility, ks_susceptibility, xc_kernel, dyson, sum_rule
...
def main():
    ...
    # Solve exact TDSE, then reverse-engineer to get v_ks
        ...
        eigv, eigf = np.linalg.eigh(ks_response)
        print(eigv)
